...
contract AaveV3 is IProtocol, Ownable {
    ...
    function addATokenMapping(address _token, address _atoken)
        external
        onlyOwner
    {
    ...
    function addDebtTokenMapping(address _token, address _debtToken)
        external
        onlyOwner
    {
    ...
    function withdrawOnBehalf(
        ...
        aavePool.withdraw(_asset, _amount, xrefinancer);
    }
